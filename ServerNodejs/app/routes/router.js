                            ...
                            for (var i = 0; i < rows.length; i++) {
                                ...
                                for (var k = 0; k < posti.length; k++)
                                    if (posti[k].id_parcheggio == parcheggio.id) {
                                        parcheggio.postiAuto = posti[k].auto || 0;
                                        parcheggio.postiAutobus = posti[k].autobus || 0;
                                        parcheggio.postiCamper = posti[k].camper || 0;
                                        parcheggio.postiMoto = posti[k].moto || 0;
                                        parcheggio.postiDisabile = posti[k].disabile || 0;
                                    }
